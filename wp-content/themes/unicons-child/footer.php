...
<!--FOOTER SIDEBAR-->
  <div id="footer">
      ...
      <?php if( !empty($footerwidgets_bg_imagee) ):?><div class="overlay"></div><?php endif; ?>
   			<div class="row mb50 mt50 overlay-fix contentWidgets">
        ...
        <div class="<?php if ( true == get_theme_mod( 'unicons_social_boxfoo', false ) ) : ?> large-6 <?php endif;?> small-12 columns">
          <div class="copytext">
           	<?php
				    ...
				    ?>
            	<a href="http://p2.m-raes.fr/mentions-legales/">Mentions légales</a>
							<a href="http://p2.m-raes.fr/wp-admin/">Administration</a>
          </div>
        </div>
